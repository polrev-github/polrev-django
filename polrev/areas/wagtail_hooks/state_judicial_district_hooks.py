...
class StateJudicialDistrictAdmin(ModelAdmin):
    ...
    menu_label = "State Judicial Districts"
...
def register_state_judicial_district_chooser_viewset():
    return StateJudicialDistrictChooserViewSet(
        "state_judicial_district_chooser", url_prefix="state-judicial-district-chooser"
    )
