...
#from offices.forms import CountyCouncilOfficeForm
from areas.models import CountyCouncilDistrict

class CountyCouncilOfficeChooserMixin(ModelChooserMixin):
    preserve_url_parameters = ['state_ref', 'county_ref', 'district_ref', 'office_type_ref']
...
class CountyCouncilOfficeChooserViewSet(ModelChooserViewSet):
    ...
    #form_class = CountyCouncilOfficeForm
    icon = 'user'
