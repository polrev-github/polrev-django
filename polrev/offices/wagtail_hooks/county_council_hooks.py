...
class CountyCouncilOfficeAdmin(ModelAdmin):
    ...
    menu_label = (
        "County Council Offices"  # ditch this to use verbose_name_plural from model
    )
...
def register_county_chooser_viewset():
    return CountyCouncilOfficeChooserViewSet(
        "county_council_office_chooser", url_prefix="county-council-office-chooser"
    )
