...
class LocalCouncilOfficeAdmin(ModelAdmin):
    ...
    menu_label = (
        "Local Council Offices"  # ditch this to use verbose_name_plural from model
    )
...
def register_county_chooser_viewset():
    return LocalCouncilOfficeChooserViewSet(
        "local_council_office_chooser", url_prefix="local-council-office-chooser"
    )
