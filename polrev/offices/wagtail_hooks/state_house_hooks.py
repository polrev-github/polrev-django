...
class StateHouseOfficeAdmin(ModelAdmin):
    ...
    menu_label = 'State House Offices'  # ditch this to use verbose_name_plural from model
...
modeladmin_register(StateHouseOfficeAdmin)

@hooks.register('register_admin_viewset')
def register_state_house_district_chooser_viewset():
    return StateHouseOfficeChooserViewSet('state_house_office_chooser', url_prefix='state-house-office-chooser')
