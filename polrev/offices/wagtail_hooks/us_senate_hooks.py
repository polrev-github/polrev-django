...
class UsSenateOfficeAdmin(ModelAdmin):
    ...
    menu_label = (
        "U.S. Senate Offices"  # ditch this to use verbose_name_plural from model
    )
...
def register_congressional_district_chooser_viewset():
    return UsSenateOfficeChooserViewSet(
        "us_senate_office_chooser", url_prefix="us-senate-office-chooser"
    )
