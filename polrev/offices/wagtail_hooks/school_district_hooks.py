...
class SchoolDistrictOfficeAdmin(ModelAdmin):
    ...
    menu_label = (
        "School District Offices"  # ditch this to use verbose_name_plural from model
    )
...
def register_school_district_chooser_viewset():
    return SchoolDistrictOfficeChooserViewSet(
        "school_district_office_chooser", url_prefix="school-district-office-chooser"
    )
